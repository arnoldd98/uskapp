...
public class ProfileActivity extends AppCompatActivity {
    ...
    Button signOutBtn,followingPostBtn,pastPostsBtn,pastCommentsBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //pastPostsBtn = findViewById(R.id.PastPostBtn);
        //pastCommentsBtn = findViewById(R.id.PastCommentsBtn);
        //followingPostBtn = findViewById(R.id.followingPostBtn);
